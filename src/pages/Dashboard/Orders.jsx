              ...
              <tr key={order._id}>
                ...
                <td>
                  ...
                  >
                    ...
                    <option value="shipped" className="text-yellow-500 font-semibold">
                      Shipped
                    </option>
                    <option value="delivered" className="text-green-500 font-semibold">
                      Delivered
                    </option>
                    <option value="canceled" className="text-red-500 font-semibold">
                      Canceled
                    </option>
                  </select>
                </td>
