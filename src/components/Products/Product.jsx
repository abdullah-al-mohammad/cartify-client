    ...
    <>
      <div className="card shadow-md dark:bg-gray-600">
        ...
        <div className="card-body">
          <h2 className="text-2xl font-bold line-clamp-1 min-h-6 text-ellipsis">{product.name}</h2>
          <p className="line-clamp-2 min-h-14 leading-loose text-ellipsis">{product.description}</p>
